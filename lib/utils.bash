...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for scarb.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for scarb
...
install_version() {
	...
	(
		...
		# TODO: Assert scarb executable exists.
		local tool_cmd
